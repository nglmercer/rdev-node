...
const { ButtonType, EventTypeValue, getDisplaySize, initSimulation, isModifierKey, KeyCode, NormalizedModifier, normalizeKeyName, simulateEvent, startListener, stopListener, stringKeyToKeycode } = nativeBinding
export { ButtonType }
export { EventTypeValue }
export { getDisplaySize }
export { initSimulation }
export { isModifierKey }
export { KeyCode }
export { NormalizedModifier }
export { normalizeKeyName }
export { simulateEvent }
export { startListener }
export { stopListener }
export { stringKeyToKeycode }
